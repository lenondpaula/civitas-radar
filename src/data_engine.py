...
CENARIOS: Dict[str, dict] = {
    ...
    "Crise de Produto / Serviço": {
        "distribuicao": {"Negativo": 0.70, "Neutro": 0.20, "Positivo": 0.10},
        "keywords": {
            "Negativo": [
                "produto com defeito de fábrica, impossível usar",
                "serviço fora do ar desde ontem, prejuízo total",
                "lote inteiro apresentou falha, cadê o recall?",
                "o app travou na hora do pagamento, perdi a compra",
                "SLA estourado e ninguém dá satisfação",
                "garantia recusou troca, absurdo com o consumidor",
                "prometeram 24h e já passou de uma semana",
                "falha crítica no produto, risco para todos",
                "assistência técnica lotada, fila interminável",
                "reembolso travado, atendimento não resolve",
                "entregaram peça errada e ninguém troca",
                "cobrança duplicada e suporte inacessível",
                "produto novo e já quebrou no primeiro uso",
                "central de suporte só dá resposta automática",
            ],
            "Neutro": [
                "empresa informou que está investigando o problema",
                "comunicado oficial sobre a falha foi publicado",
                "aberto chamado de suporte, aguardando retorno",
                "manual de uso atualizado no site",
                "canal exclusivo de suporte foi aberto",
            ],
            "Positivo": [
                "trocaram o produto na hora, atendimento rápido",
                "plano de reparo transparente, boa postura",
                "suporte resolveu em minutos, parabéns",
                "garantia estendida para todos os clientes afetados",
            ],
        },
    },
    "Escândalo de Marca": {
        ...
        "keywords": {
            "Negativo": [
                "campanha ofensiva virou boicote nacional",
                "marca apagou comentários e piorou a crise",
                "patrocinador rescindiu contrato, imagem manchada",
                "publicidade totalmente fora de tom, vergonha",
                "acusação de greenwashing pegou mal",
                "crise de reputação sem precedentes",
                "influencer rompeu com a marca publicamente",
                "hashtags de boicote dominam as redes",
                "perderam credibilidade com os consumidores",
                "nota fria e sem empatia, revoltante",
                "gestão de crise amadora e confusa",
                "clientes pedindo cancelamento em massa",
            ],
            "Neutro": [
                "marca divulgou nota oficial sobre o caso",
                "advogados estão avaliando as denúncias",
                "reunião do conselho marcada para esta semana",
                "empresa disse que vai revisar processos internos",
                "agência de publicidade foi afastada",
            ],
            "Positivo": [
                "pedido de desculpas foi direto e transparente",
                "marca anunciou medidas de reparação",
                "ouviram a comunidade e ajustaram a campanha",
                "ação social real após a crise, ponto positivo",
            ],
        },
    },
    "Campanha de Alto Impacto": {
        "distribuicao": {"Negativo": 0.20, "Neutro": 0.20, "Positivo": 0.60},
        "keywords": {
            "Positivo": [
                "campanha viralizou e bateu recorde de engajamento",
                "parceria com artista trouxe visibilidade enorme",
                "lançamento esgotou em horas, sucesso total",
                "publicidade criativa e marcante, parabéns",
                "a marca virou tendência em todas as redes",
                "ativação foi impecável, experiência incrível",
                "share of voice disparou, ótima estratégia",
                "campanha tocou o público do jeito certo",
                "collab ficou linda, todo mundo querendo",
                "reposicionamento forte e positivo, ótima execução",
            ],
            "Neutro": [
                "empresa anunciou campanha global hoje cedo",
                "evento de lançamento confirmado para sexta-feira",
                "teaser saiu nas redes, vamos ver o que vem",
                "cronograma de ativações divulgado",
            ],
            "Negativo": [
                "campanha cara demais e sem retorno",
                "slogan não agradou o público",
                "ativação pareceu forçada e artificial",
                "muito barulho e pouca entrega",
            ],
        },
    },
    "Ciberataque e Vazamento de Dados": {
        "distribuicao": {"Negativo": 0.80, "Neutro": 0.12, "Positivo": 0.08},
        "keywords": {
            "Negativo": [
                "dados pessoais vazados, isso é gravíssimo",
                "credenciais expostas e ninguém dá explicação",
                "serviços indisponíveis por causa de ransomware",
                "aplicativo travado após o ataque, prejuízo geral",
                "empresa demorou dias para avisar os clientes",
                "vazamento de cartões, pânico total",
                "backup falhou e perdemos tudo",
                "ataque derrubou o site no meio do evento",
                "falha de segurança inaceitável",
                "clientes com golpes por causa do vazamento",
                "resposta lenta e sem transparência",
                "dados sensíveis pararam em fóruns",
            ],
            "Neutro": [
                "empresa informou que está investigando o incidente",
                "autoridades foram notificadas sobre o vazamento",
                "auditoria externa foi contratada",
                "comunicado técnico publicado no site",
            ],
            "Positivo": [
                "atualização de segurança foi rápida e eficaz",
                "empresa ofereceu monitoramento gratuito de crédito",
                "restauração do sistema aconteceu em poucas horas",
                "postura transparente com os usuários, ponto positivo",
            ],
        },
    },
    "Crise Trabalhista": {
        ...
        "keywords": {
            "Negativo": [
                "greve geral parou tudo hoje cedo",
                "demissões em massa sem aviso, revoltante",
                "condições de trabalho precárias, ninguém aguenta",
                "turno exaustivo e salário atrasado",
                "funcionários denunciaram falta de segurança",
                "assédio no ambiente de trabalho, empresa omissa",
                "benefícios cortados do dia para a noite",
                "clima interno péssimo, muita gente saindo",
                "negociação travada há meses",
                "produtividade despencou por causa do conflito",
            ],
            "Neutro": [
                "sindicato convocou assembleia para amanhã",
                "empresa iniciou rodada de negociação",
                "mediador foi indicado para o acordo",
                "nota oficial sobre a greve foi publicada",
            ],
            "Positivo": [
                "acordo coletivo foi fechado, fim da greve",
                "reajuste salarial aprovado pelos trabalhadores",
                "empresa anunciou melhorias nas condições",
                "diálogo aberto resolveu o impasse",
            ],
        },
    },
    "Cancelamento Digital": {
        ...
        "keywords": {
            "Negativo": [
                "foi cancelado nas redes, perdeu patrocínio",
                "print antigo voltou e pegou muito mal",
                "explicação confusa só piorou a situação",
                "tendência de boicote subindo rápido",
                "comentários negativos não param de crescer",
                "marcas se afastando para evitar crise",
                "vídeo polêmico viralizou em minutos",
                "foi cobrado por posicionamento e ficou em silêncio",
            ],
            "Neutro": [
                "assessoria publicou nota de esclarecimento",
                "perfil temporariamente desativado",
                "equipe jurídica avaliando medidas",
                "post de explicação marcado para hoje",
            ],
            "Positivo": [
                "pedido de desculpas foi bem recebido",
                "aprendeu com o erro e mudou postura",
                "retorno às redes com apoio dos seguidores",
                "debate virou oportunidade de melhoria",
            ],
        },
    },
    "Prêmio / Reconhecimento": {
        ...
        "keywords": {
            "Positivo": [
                "ganhou prêmio internacional, orgulho total",
                "reconhecimento merecido pelo trabalho",
                "entrou no ranking das marcas mais admiradas",
                "premiação histórica para a equipe",
                "foi destaque no setor pela inovação",
                "recebeu selo de qualidade e excelência",
                "o mercado aplaudiu a conquista",
                "história inspiradora, parabéns a todos",
            ],
            "Neutro": [
                "indicada ao prêmio deste ano",
                "cerimônia acontece na próxima semana",
                "lista de finalistas foi divulgada hoje",
                "julgamento técnico segue em andamento",
            ],
            "Negativo": [
                "prêmio comprado, ninguém acredita",
                "premiação sem credibilidade",
                "foi injusto com outros concorrentes",
                "muito lobby por trás desse prêmio",
            ],
        },
    },
    "Vida Pessoal em Pauta": {
        "distribuicao": {"Negativo": 0.55, "Neutro": 0.30, "Positivo": 0.15},
        "keywords": {
            "Negativo": [
                "exposição exagerada da vida pessoal, sem limites",
                "boatos circulando e ninguém confirma",
                "vazaram fotos privadas, invasão total",
                "comentários maldosos sobre a família",
                "fofoca tomou conta das redes",
                "vida pessoal virou pauta principal, que absurdo",
                "especulações sem fundamento só pioram",
                "assuntos íntimos viraram manchete",
            ],
            "Neutro": [
                "foto com a família circulou nas redes",
                "entrevista falou sobre a vida fora do trabalho",
                "comentou discretamente o assunto",
                "assessoria pediu respeito à privacidade",
            ],
            "Positivo": [
                "gesto humano aproximou o público",
                "post sincero gerou empatia",
                "família demonstrou apoio nas redes",
                "mensagem pessoal tocou muita gente",
            ],
        },
    },
}
